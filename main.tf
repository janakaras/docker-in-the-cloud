...
provider "aws" {
  profile    = "default"
  access_key = "ASIAWEEGKEYJU7S3A3TJ"
  secret_key = "lsw3UGhmilsqeOuPFRWirh/BU1NsmSQKmGqX0jyx"
  token      = ""
  region     = "us-east-1"
}
...
resource "aws_key_pair" "deployer" {
  key_name_prefix   = "ec2-deployer-key-pair"
